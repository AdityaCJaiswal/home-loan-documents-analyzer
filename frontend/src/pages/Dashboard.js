      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <Link to="/upload" className="group">
            <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl p-8 text-white shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-300 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Add to your RAG library</p>
                  </div>
                </div>
              </div>
          ...
          <div className="group cursor-pointer" onClick={() => document.getElementById('documents-section').scrollIntoView({ behavior: 'smooth' })}>
            <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl p-8 text-white shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-300 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center space-x-4 mb-4">
                  <div className="p-4 bg-white/20 rounded-2xl group-hover:bg-white/30 transition-colors">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold">Browse RAG Library</h3>
                    <p className="text-purple-100">Explore document collection</p>
                  </div>
                </div>
              </div>
          ...
          {/* --- NEW ACTION CARD FOR YOUR DEMO --- */}
          <Link to="/loan-demo" className="group">
            <div className="bg-gradient-to-br from-red-500 to-orange-600 rounded-3xl p-8 text-white shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-300 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center space-x-4 mb-4">
                  <div className="p-4 bg-white/20 rounded-2xl group-hover:bg-white/30 transition-colors">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold">Loan Analyzer Demo</h3>
                    <p className="text-red-100">Run Risk Interceptor</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center space-x-2 text-red-100">
                <Zap className="h-5 w-5" />
                <span>Knowledge Base Powered</span>
              </div>
            </div>
          </Link>
          {/* --- END NEW ACTION CARD --- */}
        ...
        <div id="documents-section" className="max-w-7xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Document Library (RAG)</h2>
